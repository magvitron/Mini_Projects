...
#include "V3_2_MatlabFn_UnitTest_sfun.h"
#include "c1_V3_2_MatlabFn_UnitTest.h"
#define CHARTINSTANCE_CHARTNUMBER      (chartInstance->chartNumber)
#define CHARTINSTANCE_INSTANCENUMBER   (chartInstance->instanceNumber)
#include "V3_2_MatlabFn_UnitTest_sfun_debug_macros.h"
...
static void initialize_c1_V3_2_MatlabFn_UnitTest
  (SFc1_V3_2_MatlabFn_UnitTestInstanceStruct *chartInstance);
static void initialize_params_c1_V3_2_MatlabFn_UnitTest
  (SFc1_V3_2_MatlabFn_UnitTestInstanceStruct *chartInstance);
static void enable_c1_V3_2_MatlabFn_UnitTest
  (SFc1_V3_2_MatlabFn_UnitTestInstanceStruct *chartInstance);
static void disable_c1_V3_2_MatlabFn_UnitTest
  (SFc1_V3_2_MatlabFn_UnitTestInstanceStruct *chartInstance);
static void c1_update_debugger_state_c1_V3_2_MatlabFn_UnitTest
  (SFc1_V3_2_MatlabFn_UnitTestInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c1_V3_2_MatlabFn_UnitTest
  (SFc1_V3_2_MatlabFn_UnitTestInstanceStruct *chartInstance);
static void set_sim_state_c1_V3_2_MatlabFn_UnitTest
  (SFc1_V3_2_MatlabFn_UnitTestInstanceStruct *chartInstance, const mxArray
   *c1_st);
static void finalize_c1_V3_2_MatlabFn_UnitTest
  (SFc1_V3_2_MatlabFn_UnitTestInstanceStruct *chartInstance);
static void sf_gateway_c1_V3_2_MatlabFn_UnitTest
  (SFc1_V3_2_MatlabFn_UnitTestInstanceStruct *chartInstance);
static void mdl_start_c1_V3_2_MatlabFn_UnitTest
  (SFc1_V3_2_MatlabFn_UnitTestInstanceStruct *chartInstance);
static void c1_chartstep_c1_V3_2_MatlabFn_UnitTest
  (SFc1_V3_2_MatlabFn_UnitTestInstanceStruct *chartInstance);
static void initSimStructsc1_V3_2_MatlabFn_UnitTest
  (SFc1_V3_2_MatlabFn_UnitTestInstanceStruct *chartInstance);
static void init_script_number_translation(uint32_T c1_machineNumber, uint32_T
  c1_chartNumber, uint32_T c1_instanceNumber);
static const mxArray *c1_sf_marshallOut(void *chartInstanceVoid, void *c1_inData);
static real_T c1_emlrt_marshallIn(SFc1_V3_2_MatlabFn_UnitTestInstanceStruct
  *chartInstance, const mxArray *c1_b_en_ev_charg, const char_T *c1_identifier);
static real_T c1_b_emlrt_marshallIn(SFc1_V3_2_MatlabFn_UnitTestInstanceStruct
...
static const mxArray *c1_d_sf_marshallOut(void *chartInstanceVoid, void
  *c1_inData);
static int32_T c1_c_emlrt_marshallIn(SFc1_V3_2_MatlabFn_UnitTestInstanceStruct
  *chartInstance, const mxArray *c1_u, const emlrtMsgIdentifier *c1_parentId);
static void c1_b_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c1_mxArrayInData, const char_T *c1_varName, void *c1_outData);
static uint8_T c1_d_emlrt_marshallIn(SFc1_V3_2_MatlabFn_UnitTestInstanceStruct
  *chartInstance, const mxArray *c1_b_is_active_c1_V3_2_MatlabFn_UnitTest, const
  char_T *c1_identifier);
static uint8_T c1_e_emlrt_marshallIn(SFc1_V3_2_MatlabFn_UnitTestInstanceStruct
  *chartInstance, const mxArray *c1_u, const emlrtMsgIdentifier *c1_parentId);
static void init_dsm_address_info(SFc1_V3_2_MatlabFn_UnitTestInstanceStruct
  *chartInstance);
static void init_simulink_io_address(SFc1_V3_2_MatlabFn_UnitTestInstanceStruct
  *chartInstance);
  ...
  (SFc1_V3_2_MatlabFn_UnitTestInstanceStruct *chartInstance)
{
  if (sf_is_first_init_cond(chartInstance->S)) {
    initSimStructsc1_V3_2_MatlabFn_UnitTest(chartInstance);
    chart_debug_initialize_data_addresses(chartInstance->S);
  }

  chartInstance->c1_sfEvent = CALL_EVENT;
  _sfTime_ = sf_get_time(chartInstance->S);
  chartInstance->c1_is_active_c1_V3_2_MatlabFn_UnitTest = 0U;
}
  ...
  (SFc1_V3_2_MatlabFn_UnitTestInstanceStruct *chartInstance)
{
  ...
  c1_h_hoistedGlobal = chartInstance->c1_is_active_c1_V3_2_MatlabFn_UnitTest;
  c1_i_y = NULL;
   ...
   *c1_st)
{
  ...
  *chartInstance->c1_route_pvOrGrid2bms = c1_emlrt_marshallIn(chartInstance,
  ...
  chartInstance->c1_is_active_c1_V3_2_MatlabFn_UnitTest = c1_d_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c1_u, 7)),
     "is_active_c1_V3_2_MatlabFn_UnitTest");
  sf_mex_destroy(&c1_u);
  c1_update_debugger_state_c1_V3_2_MatlabFn_UnitTest(chartInstance);
  ...
  (SFc1_V3_2_MatlabFn_UnitTestInstanceStruct *chartInstance)
{
  ...
  chartInstance->c1_sfEvent = CALL_EVENT;
  c1_chartstep_c1_V3_2_MatlabFn_UnitTest(chartInstance);
  _SFD_SYMBOL_SCOPE_POP();
  _SFD_CHECK_FOR_STATE_INCONSISTENCY(_V3_2_MatlabFn_UnitTestMachineNumber_,
  ...
  if (CV_EML_COND(0, 1, 0, c1_b_off_peak) && CV_EML_COND(0, 1, 1,
    ...
    if (CV_EML_COND(0, 1, 4, c1_b_off_peak) && CV_EML_COND(0, 1, 5, c1_b_morning)
      ...
      if (CV_EML_COND(0, 1, 8, c1_b_peak_time) && CV_EML_COND(0, 1, 9,
           ...
           1, 11, CV_RELATIONAL_EVAL(4U, 0U, 7, c1_b_bms_batt_cap, 30.0, -1, 2U,
        ...
        if (CV_EML_COND(0, 1, 13, c1_b_off_peak) && CV_EML_COND(0, 1, 14,
             CV_RELATIONAL_EVAL(4U, 0U, 9, c1_carPresent, 0.0, -1, 0U,
                                c1_carPresent == 0.0)) && CV_EML_COND(0, 1, 15,
             CV_RELATIONAL_EVAL(4U, 0U, 10, c1_b_ev_batt_cap, 90.0, -1, 2U,
                                c1_b_ev_batt_cap < 90.0))) {
          ...
          if (CV_EML_COND(0, 1, 16, c1_b_morning) && CV_EML_COND(0, 1, 17,
               CV_RELATIONAL_EVAL(4U, 0U, 11, c1_b_bms_batt_cap, 90.0, -1, 4U,
                                  c1_b_bms_batt_cap > 90.0)) && CV_EML_COND(0, 1,
               18, CV_RELATIONAL_EVAL(4U, 0U, 12, c1_carPresent, 0.0, -1, 0U,
                c1_carPresent == 0.0)) && CV_EML_COND(0, 1, 19,
               CV_RELATIONAL_EVAL(4U, 0U, 13, c1_b_ev_batt_cap, 90.0, -1, 4U,
                                  c1_b_ev_batt_cap > 90.0))) {
...
static const mxArray *c1_sf_marshallOut(void *chartInstanceVoid, void *c1_inData)
{
  ...
  const mxArray *c1_y = NULL;
  SFc1_V3_2_MatlabFn_UnitTestInstanceStruct *chartInstance;
  chartInstance = (SFc1_V3_2_MatlabFn_UnitTestInstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c1_V3_2_MatlabFn_UnitTest_get_eml_resolved_functions_info(void)
{
  ...
  char_T *c1_identifier)
{
  ...
  c1_y = c1_e_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c1_b_is_active_c1_V3_2_MatlabFn_UnitTest), &c1_thisId);
  sf_mex_destroy(&c1_b_is_active_c1_V3_2_MatlabFn_UnitTest);
  return c1_y;
}
...
void sf_c1_V3_2_MatlabFn_UnitTest_get_check_sum(mxArray *plhs[])
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(978994454U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(2514107036U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(2435620185U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(3565444540U);
}

mxArray* sf_c1_V3_2_MatlabFn_UnitTest_get_post_codegen_info(void);
mxArray *sf_c1_V3_2_MatlabFn_UnitTest_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("dETdsCszluVgBRxOAFAsZB");
...

  {
    mxArray* mxPostCodegenInfo =
      sf_c1_V3_2_MatlabFn_UnitTest_get_post_codegen_info();
...
mxArray *sf_c1_V3_2_MatlabFn_UnitTest_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c1_V3_2_MatlabFn_UnitTest_jit_fallback_info(void)
{
...
mxArray *sf_c1_V3_2_MatlabFn_UnitTest_updateBuildInfo_args_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c1_V3_2_MatlabFn_UnitTest(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x8'type','srcId','name','auxInfo'{{M[1],M[26],T\"en_bat_ev_charge\",},{M[1],M[12],T\"en_batt_charg\",},{M[1],M[10],T\"en_batt_grid\",},{M[1],M[13],T\"en_ev_charg\",},{M[1],M[11],T\"en_grid_batt\",},{M[1],M[5],T\"en_mppt\",},{M[1],M[25],T\"route_pvOrGrid2bms\",},{M[8],M[0],T\"is_active_c1_V3_2_MatlabFn_UnitTest\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 8, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c1_V3_2_MatlabFn_UnitTest_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    SFc1_V3_2_MatlabFn_UnitTestInstanceStruct *chartInstance =
      (SFc1_V3_2_MatlabFn_UnitTestInstanceStruct *)sf_get_chart_instance_ptr(S);
    if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
      /* do this only if simulation is starting */
      {
        ...
        chartAlreadyPresent = sf_debug_initialize_chart
          (sfGlobalDebugInstanceStruct,
           _V3_2_MatlabFn_UnitTestMachineNumber_,
           1,
           1,
           1,
           0,
        ...
        init_script_number_translation(_V3_2_MatlabFn_UnitTestMachineNumber_,
          chartInstance->chartNumber,chartInstance->instanceNumber);
        if (chartAlreadyPresent==0) {
          /* this is the first instance */
          sf_debug_set_chart_disable_implicit_casting
            (sfGlobalDebugInstanceStruct,_V3_2_MatlabFn_UnitTestMachineNumber_,
        ...
        _SFD_CV_INIT_EML(0,1,1,0,6,0,0,0,0,0,20,5);
        _SFD_CV_INIT_EML_FCN(0,0,"eML_blk_kernel",0,-1,4282);
        _SFD_CV_INIT_EML_IF(0,1,0,687,706,727,754);
        _SFD_CV_INIT_EML_IF(0,1,1,756,830,1544,4280);
        _SFD_CV_INIT_EML_IF(0,1,2,1544,1610,2322,4280);
        _SFD_CV_INIT_EML_IF(0,1,3,2322,2409,3115,4280);
        _SFD_CV_INIT_EML_IF(0,1,4,3115,3170,3875,4280);
        _SFD_CV_INIT_EML_IF(0,1,5,3875,3950,4111,4280);
        ...
        {
          static int condStart[] = { 3123, 3136, 3153 };

          static int condEnd[] = { 3131, 3149, 3169 };

          static int pfixExpr[] = { 0, 1, -3, 2, -3 };

          _SFD_CV_INIT_EML_MCDC(0,1,3,3123,3169,3,13,&(condStart[0]),&(condEnd[0]),
                                5,&(pfixExpr[0]));
        }

        {
          static int condStart[] = { 3883, 3895, 3915, 3933 };

          static int condEnd[] = { 3890, 3911, 3928, 3949 };

          static int pfixExpr[] = { 0, 1, -3, 2, -3, 3, -3 };

          _SFD_CV_INIT_EML_MCDC(0,1,4,3883,3949,4,16,&(condStart[0]),&(condEnd[0]),
                                7,&(pfixExpr[0]));
        }

        _SFD_CV_INIT_EML_RELATIONAL(0,1,0,690,705,-1,2);
        ...
        _SFD_CV_INIT_EML_RELATIONAL(0,1,7,2372,2388,-1,2);
        _SFD_CV_INIT_EML_RELATIONAL(0,1,8,2392,2408,-1,2);
        _SFD_CV_INIT_EML_RELATIONAL(0,1,9,3136,3149,-1,0);
        _SFD_CV_INIT_EML_RELATIONAL(0,1,10,3153,3169,-1,2);
        _SFD_CV_INIT_EML_RELATIONAL(0,1,11,3895,3911,-1,4);
        _SFD_CV_INIT_EML_RELATIONAL(0,1,12,3915,3928,-1,0);
        _SFD_CV_INIT_EML_RELATIONAL(0,1,13,3933,3949,-1,4);
      ...
      sf_debug_reset_current_state_configuration(sfGlobalDebugInstanceStruct,
        _V3_2_MatlabFn_UnitTestMachineNumber_,chartInstance->chartNumber,
        chartInstance->instanceNumber);
    }
  }
}
...
{
  return "sCjGciENANlWrmg92tztjHH";
}

static void sf_opaque_initialize_c1_V3_2_MatlabFn_UnitTest(void
  *chartInstanceVar)
{
  chart_debug_initialization(((SFc1_V3_2_MatlabFn_UnitTestInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c1_V3_2_MatlabFn_UnitTest
    ((SFc1_V3_2_MatlabFn_UnitTestInstanceStruct*) chartInstanceVar);
  initialize_c1_V3_2_MatlabFn_UnitTest
    ((SFc1_V3_2_MatlabFn_UnitTestInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c1_V3_2_MatlabFn_UnitTest(void *chartInstanceVar)
{
  enable_c1_V3_2_MatlabFn_UnitTest((SFc1_V3_2_MatlabFn_UnitTestInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_disable_c1_V3_2_MatlabFn_UnitTest(void *chartInstanceVar)
{
  disable_c1_V3_2_MatlabFn_UnitTest((SFc1_V3_2_MatlabFn_UnitTestInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_gateway_c1_V3_2_MatlabFn_UnitTest(void *chartInstanceVar)
{
  sf_gateway_c1_V3_2_MatlabFn_UnitTest
    ((SFc1_V3_2_MatlabFn_UnitTestInstanceStruct*) chartInstanceVar);
}

static const mxArray* sf_opaque_get_sim_state_c1_V3_2_MatlabFn_UnitTest
  (SimStruct* S)
{
  return get_sim_state_c1_V3_2_MatlabFn_UnitTest
    ((SFc1_V3_2_MatlabFn_UnitTestInstanceStruct *)sf_get_chart_instance_ptr(S));/* raw sim ctx */
}

static void sf_opaque_set_sim_state_c1_V3_2_MatlabFn_UnitTest(SimStruct* S,
  const mxArray *st)
{
  set_sim_state_c1_V3_2_MatlabFn_UnitTest
    ((SFc1_V3_2_MatlabFn_UnitTestInstanceStruct*)sf_get_chart_instance_ptr(S),
     st);
}

static void sf_opaque_terminate_c1_V3_2_MatlabFn_UnitTest(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc1_V3_2_MatlabFn_UnitTestInstanceStruct*)
                    chartInstanceVar)->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
      unload_V3_2_MatlabFn_UnitTest_optimization_info();
    }

    finalize_c1_V3_2_MatlabFn_UnitTest
      ((SFc1_V3_2_MatlabFn_UnitTestInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc1_V3_2_MatlabFn_UnitTest
    ((SFc1_V3_2_MatlabFn_UnitTestInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c1_V3_2_MatlabFn_UnitTest(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c1_V3_2_MatlabFn_UnitTest(SimStruct *S)
{
  ...
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    mxArray *infoStruct = load_V3_2_MatlabFn_UnitTest_optimization_info
  ...
  ssSetChecksum0(S,(3112363069U));
  ssSetChecksum1(S,(3603460213U));
  ssSetChecksum2(S,(3923804533U));
  ssSetChecksum3(S,(2939455658U));
...
static void mdlRTW_c1_V3_2_MatlabFn_UnitTest(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c1_V3_2_MatlabFn_UnitTest(SimStruct *S)
{
  SFc1_V3_2_MatlabFn_UnitTestInstanceStruct *chartInstance;
  chartInstance = (SFc1_V3_2_MatlabFn_UnitTestInstanceStruct *)utMalloc(sizeof
    (SFc1_V3_2_MatlabFn_UnitTestInstanceStruct));
  if (chartInstance==NULL) {
    sf_mex_error_message("Could not allocate memory for chart instance.");
  }

  memset(chartInstance, 0, sizeof(SFc1_V3_2_MatlabFn_UnitTestInstanceStruct));
  chartInstance->chartInfo.chartInstance = chartInstance;
  chartInstance->chartInfo.isEMLChart = 1;
  chartInstance->chartInfo.chartInitialized = 0;
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c1_V3_2_MatlabFn_UnitTest;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c1_V3_2_MatlabFn_UnitTest;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c1_V3_2_MatlabFn_UnitTest;
  chartInstance->chartInfo.enableChart =
    sf_opaque_enable_c1_V3_2_MatlabFn_UnitTest;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c1_V3_2_MatlabFn_UnitTest;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c1_V3_2_MatlabFn_UnitTest;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c1_V3_2_MatlabFn_UnitTest;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c1_V3_2_MatlabFn_UnitTest;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c1_V3_2_MatlabFn_UnitTest;
  chartInstance->chartInfo.mdlStart = mdlStart_c1_V3_2_MatlabFn_UnitTest;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c1_V3_2_MatlabFn_UnitTest;
  ...
  mdl_start_c1_V3_2_MatlabFn_UnitTest(chartInstance);
}

void c1_V3_2_MatlabFn_UnitTest_method_dispatcher(SimStruct *S, int_T method,
  void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c1_V3_2_MatlabFn_UnitTest(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c1_V3_2_MatlabFn_UnitTest(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c1_V3_2_MatlabFn_UnitTest(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c1_V3_2_MatlabFn_UnitTest_method_dispatcher.\n"
